...
# Create an `about.html` view to render a static about.html page
def about(request):
    context = {}
    if request.method == "GET":
        return render(request, 'djangoapp/about.html.html', context)
...
def get_dealerships(request):
    if request.method == "GET":
        ...
        url = "https://dbe10acb.us-south.apigw.appdomain.cloud/api/dealership"
...
def get_dealer_details(request, dealer_id):
    if request.method == "GET":
        context = {}
        url = "https://dbe10acb.us-south.apigw.appdomain.cloud/api/review"
